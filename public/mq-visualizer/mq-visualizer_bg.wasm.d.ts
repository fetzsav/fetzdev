...
export const wasm_bindgen__convert__closures_____invoke__h863f95fd9dec1424: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__had19b773cb6ac20a: (a: number, b: number) => void;
